...
<template>
  <Teleport to="body">
    <div
      ...
      class="absolute left-0 top-0 flex h-screen w-full justify-center overflow-auto bg-gray-600/30 bg-opacity-60 px-8 dark:bg-gray-300/30"
    >
      <div
        ref="target"
        v-if="isModalActive"
        class="relative mx-auto mt-32 w-11/12 max-w-screen-md self-start bg-gray-100 p-6 text-teal-700 shadow-md sm:rounded-lg md:w-2/3 dark:bg-gray-700 dark:text-teal-300"
      >
